// Made by Ben Bollinger: https://termspar.wordpress.com/2019/04/11/c-sfml-textbox-and-button-classes/
...
public:
    Textbox(int size, sf::Color color, bool sel) {
        ...
        if(isSelected)
            ...
            textbox.setString("Search a song");
    }
    ...
    void setSelected(bool sel) {
        ...
        if (!sel) {
            ...
            std::string newT = "Search for a Song";
    ...
    void setTextBox(std::string message){
        clearText();
        std::string t = text.str();
        std::string newT = "";
        text.str("");
